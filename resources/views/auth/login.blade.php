        ...
        <div class="grid lg:grid-cols-2">
            ...
            >
                ...
                <form method="POST" action="{{ route('login') }}" class="grid gap-6">
                    ...
                    <label for="email" value="{{ __('Email') }}" class="block">
                    <input
                        id="email" type="email" name="email" :value="{{old('email')}}" required autofocus
                        class="block w-full rounded-full py-4 text-[#1E2B4F] font-medium placeholder:text-[#AFAEC3]
                        placeholder:font-normal px-7 border border-[#d4d4d4] focus:outline-none focus:border-[#0D63F3]"
                    ...
                    <label for="password" value="{{ __('Password') }}" class="block">
                    <input
