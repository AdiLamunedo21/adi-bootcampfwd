    ...
    <nav x-data="{ navbarMobileOpen: false }" class="bg-white">
        <div class="max-w-7xl mx-auto px-4 lg:px-14 pt-6 lg:py-10">
            ...
            <div class="flex flex-auto justify-between">
                ...
                <a
                    href="{{ route('index')}}"
                    class="text-[#1E2B4F] relative {{ request()->is('/') ? "after:absolute after:content-['']
                    after:border-b-2 after:border-[#0D63F5] after:w-8/12 after:-translate-x-1/2 after:bottom-3
